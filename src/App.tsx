    ...
    <div className="mx-auto max-w-6xl px-6 py-12">
      <header className="mb-16">
        ...
        <p className="mt-4 max-w-xl text-[var(--color-muted)]">
          ...
          <code className="font-mono text-sm text-[var(--color-fg)]">src/App.tsx</code> and build the
          app you imagine.
        </p>
      </header>

      <main className="grid gap-px border border-[var(--color-line)] bg-[var(--color-line)] lg:grid-cols-2">
        <section className="bg-[var(--color-bg)] p-8">
          <SearchPanel />
        </section>
        <section className="bg-[var(--color-bg)] p-8">
          <AskPanel />
